...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2022 at 08:16 PM
...
(1, 1, '2022-11-03', '2022-11-03', 'Aktív', 80),
...
(11, 1, '2022-11-19', '2022-11-16', 'Aktív', 4),
(12, 7, '2022-11-08', '2022-11-17', 'Foglalva', 67);
...
INSERT INTO `rang` (`nev`, `szemelyiigazolvanyszam`) VALUES
('Főbérlő', 1),
('Főbérlő', 2),
('Főbérlő', 4),
('Főbérlő', 912),
...
--
ALTER TABLE `foglalas`
  MODIFY `foglalasszama` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
